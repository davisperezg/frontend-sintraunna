...
const ActionesButton = ({ ...rest }) => {
  ...
  const desactivateUser = (id: string) => {
    mutateDelete(
      {
        id: id,
      },
    ...
    <div style={{ textAlign: "center" }}>
      ...
      >
        ...
        <MenuItem
          onClick={() => {
            if (rest.row.status) {
              return desactivateUser(rest.row._id);
            } else {
              return restoreUser(rest.row._id);
            }
          }}
          disableRipple
        >
...
const UserList = ({ columns, data, isLoading, handleClickOpen }: any) => {
